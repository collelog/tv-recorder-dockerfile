...
COPY ./patch/sat/Makefile.in-rpi3.patch /tmp/
...
WORKDIR /tmp/recdvb
RUN curl -kfsSL --retry 10 --retry-delay 1 --retry-connrefused https://web.archive.org/web/20190917134748/http://www13.plala.or.jp/sat/recdvb/recdvb-1.3.2.tgz | \
		tar -xz --strip-components=1
