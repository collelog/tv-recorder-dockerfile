...
COPY ./patch/libarib25-CMakeLists-rpi4-arm64v8.patch /tmp/
COPY ./patch/recpt1-Makefile.in-rpi4-arm64v8.patch /tmp/
...
RUN mv /tmp/libarib25-CMakeLists-rpi4-arm64v8.patch /tmp/libarib25/
RUN patch < libarib25-CMakeLists-rpi4-arm64v8.patch
RUN cmake .
RUN make install
...
RUN mv /tmp/recpt1-Makefile.in-rpi4-arm64v8.patch /tmp/recpt1/recpt1/
RUN patch < recpt1-Makefile.in-rpi4-arm64v8.patch
RUN ./autogen.sh
