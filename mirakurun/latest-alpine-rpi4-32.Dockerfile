...
ENV DOCKER="YES"
WORKDIR /tmp
RUN curl -fsSLo mirakurun.zip http://github.com/Chinachu/Mirakurun/archive/refs/heads/master.zip
...
# libarib25 
FROM collelog/libarib25-build:epgdatacapbon-latest-alpine-rpi4-32 AS libarib25-image
...
# recdvb
FROM collelog/recdvb-build:kaikoma-soft-latest-alpine-rpi4-32 AS recdvb-image
