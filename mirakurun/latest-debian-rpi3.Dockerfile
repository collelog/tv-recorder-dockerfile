...
# libarib25 
FROM collelog/libarib25-build:epgdatacapbon-latest-debian-rpi3 AS libarib25-image


# recpt1
FROM collelog/recpt1-build:stz2012-latest-debian-rpi3 AS recpt1-image


# recdvb
FROM collelog/recdvb-build:kaikoma-soft-latest-debian-rpi3 AS recdvb-image


# recfsusb2n
FROM collelog/recfsusb2n-build:epgdatacapbon-latest-debian-rpi3 AS recfsusb2n-image


# arib-b25-stream-test
FROM collelog/arib-b25-stream-test-build:latest-debian-rpi3 AS arib-b25-stream-test-image
