...
# recpt1
FROM collelog/recpt1-build:stz2012-latest-debian AS recpt1-image


# recdvb
FROM collelog/recdvb-build:kaikoma-soft-latest-debian AS recdvb-image
...
FROM collelog/arib-b25-stream-test-build:latest-debian AS arib-b25-stream-test-image
