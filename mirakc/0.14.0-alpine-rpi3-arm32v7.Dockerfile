# mirakc-arib, mirakc
FROM mirakc/mirakc:0.14.0-alpine AS mirakc-image
WORKDIR /build
...
# libarib25 
FROM collelog/libarib25-build:latest-alpine-rpi3-arm32v7 AS libarib25-image


# recpt1
FROM collelog/recpt1-build:latest-alpine-rpi3-arm32v7 AS recpt1-image


# recdvb
FROM collelog/recdvb-build:latest-alpine-rpi3-arm32v7 AS recdvb-image
