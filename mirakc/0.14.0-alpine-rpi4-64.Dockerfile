...
# libarib25 
FROM collelog/libarib25-build:latest-alpine-rpi4-64 AS libarib25-image


# recpt1
FROM collelog/recpt1-build:latest-alpine-rpi4-64 AS recpt1-image
...
# recfsusb2n
FROM collelog/recfsusb2n-build:latest-alpine-rpi4-64 AS recfsusb2n-image
